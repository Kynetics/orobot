...
import playactors.ORobotPlayActor
...
import populator.CustomersPopulator

/**
 * The Guice module which wires all Silhouette dependencies.
 */
class ORobotModule extends AbstractModule with ScalaModule with AkkaGuiceSupport {
  ...
  def configure() {
    ...
    bindActor[ORobotPlayActor]("orobotplay")
    bind(classOf[CustomersPopulator]).asEagerSingleton()
  }
